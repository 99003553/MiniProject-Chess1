...
void test_pawn(void) {
  ...
  CU_ASSERT(1 == pawn(5,1,5,2));//remove the line
...
void test_rook(void) {
  ...
  CU_ASSERT(1 == rook(0,0,0,1));//remove the line
...
void test_queen(void) {
 // CU_ASSERT(1 == ches.queen(4,7,4,6));
  CU_ASSERT(1 == queen(4,7,4,6));//remove the line
...
void test_bishop(void) {
 // CU_ASSERT(1 == ches.bishop(5,7,4,7));
   CU_ASSERT(1 == bishop(5,7,4,7));//remove the line
...
void test_horse(void) {
  ...
  CU_ASSERT(1 == horse(1,7,1,6));//remove the line
...
void test_king(void) {
  ...
  CU_ASSERT(1 == king(3,7,3,6));//remove the line
